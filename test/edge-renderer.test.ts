...
const report = {
  ...
  current_stock_outcome:{
    des:-30,market_trust:{score:92,band:'VERY HIGH',subscores:{evidence_quality:95,freshness:90,completeness:88,directional_agreement:80,market_confirmation:94}},directional_agreement:80,effective_conviction:.276,
    ...
    decision_ladder:'INVESTIGATION',bot:{score:65,grade:'B',subscores:{forecast_edge:45,market_trust:92,structure_pattern_quality:60,pv_pvpo_confirmation:55,catalyst_asymmetry:50,execution_quality:60}},execution:{instrument:'NONE',option_suitability_status:'NO OPTION TRADE',execution_quality_score:60},current_price:3100
  },
  drilldown:[
    {component:'BUSINESS_FUNDAMENTALS',score_or_level:1,original_weight:10,normalized_direction:.5,normalized_weight:10,weighted_contribution:5,evidence_quality:'HIGH',verification_status:'VERIFIED',conflict_flag:false,key_outcome:'POSITIVE',narrative_source:'LEGACY_SCORE_RECONSTRUCTION',interpretation:'Legacy active run: the original narrative field was not persisted. The immutable verified component score is 1 (positive); Business fundamentals are therefore acting as a medium-term support or drag within the five-day framework.'},
    {component:'PV_PVPO',score_or_level:-1,original_weight:18,normalized_direction:-.5,normalized_weight:18,weighted_contribution:-9,evidence_quality:'HIGH',verification_status:'VERIFIED',conflict_flag:false,key_outcome:'NEGATIVE',narrative_source:'PERSISTED_EVIDENCE_NARRATIVE',interpretation:'Price weakened while participation and available derivatives confirmation did not support a bullish continuation.'},
    {component:'VALUATION',score_or_level:'N/A',original_weight:7,normalized_direction:null,normalized_weight:null,weighted_contribution:null,evidence_quality:'NOT_VERIFIED',verification_status:'NOT_VERIFIED',conflict_flag:false,key_outcome:'NOT VERIFIED',interpretation:'Required structured evidence was unavailable or insufficient; no interpretation inferred.'}
  ]
};
