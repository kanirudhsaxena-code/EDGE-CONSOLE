...
test('Console HTML forces the approved EDGE UI v7 assets',()=>{
  const html=readFileSync('public/index.html','utf8');
  assert.ok(html.includes('styles.css?v=edge-ui-v7-20260921'));
  assert.ok(html.includes('edge-live.js?v=edge-ui-v7-20260921'));
