...
function stageLabel(stage,status){if(status==='COMPLETED')return'Result ready';const map={AUTOMATED_MARKET_DATA_PENDING:'Fetching automated market data',AUTOMATED_MARKET_DATA_READY:'Checking market conditions',AUTOMATED_MARKET_DATA_BLOCKED:'Automated data unavailable · screenshot backup available',EVIDENCE_READY:'Screenshots received',SCREENSHOTS_READY:'Reading screenshot backup',VISION_READY:'Reading screenshot backup',RESEARCH_RETRIEVED:'Checking market conditions',AUTONOMOUS_EVIDENCE_READY:'Checking market conditions',INTELLIGENCE_READY:'Combining evidence',NORMALIZED_READY:'Running 5DR',PROCESSING:'Running 5DR'};return map[String(stage)]||'Preparing analysis'}
