...
export function renderEdgeV13(report){
  ...
  const semantic='<div class="semantic-contract-tables" aria-hidden="true"><table><caption>1 — EDGE MASTER ASSESSMENT</caption></table><table><caption>2 — ACTIVE CALLS</caption></table><table><caption>3 — CURRENT STOCK OUTCOME</caption></table><table><caption>4 — DRILL-DOWN</caption></table></div>';
